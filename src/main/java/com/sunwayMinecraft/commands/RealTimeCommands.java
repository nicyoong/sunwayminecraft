...
/**
 * The RealTimeCommands class handles commands that display the server's current time and date
 * in different time zones.
 *
 * <p>This class implements the {@link CommandExecutor} interface, allowing it to process the following commands:
 * <ul>
 *   <li><code>/servertime</code> – shows current time and date in local zone (Singapore Time, UTC+8).</li>
 *   <li><code>/servertimeutc</code> – shows current time and date in UTC.</li>
 * </ul>
 *
 * <p>Key functionality includes:
 * <ul>
 *   <li>Retrieving and formatting time and date information for specified time zones.</li>
 *   <li>Sending formatted time and date messages to command senders.</li>
 * </ul>
 *
 * <p>The main methods provided by this class are:
 * <ul>
 *   <li><code>onCommand</code> – routes incoming commands to the appropriate handler.</li>
 *   <li><code>sendTimeMessage</code> – formats and sends the time/date message to the sender.</li>
 * </ul>
 */
public class RealTimeCommands implements CommandExecutor {
     ...
     *
     * @param realTimeManager the manager responsible for retrieving and formatting time and date information
     */
     ...
     * <ol>
     *   <li>Checks the name of the executed command (case-insensitive).</li>
     *   <li>If the command is <code>servertime</code>, it sends the time and date in local zone (UTC+8).</li>
     *   <li>If the command is <code>servertimeutc</code>, it sends the time and date in UTC.</li>
     *   <li>If the command name does not match, returns false to indicate it was not handled.</li>
     * </ol>
     *
     ...
     * <ol>
     *   <li>Retrieves the formatted time string for the given time zone.</li>
     *   <li>Retrieves the formatted date string for the given time zone.</li>
     *   <li>Constructs and sends two messages to the sender:
     *     <ul>
     *       <li>One for the current time.</li>
     *       <li>One for the current date.</li>
     *     </ul>
     *   </li>
     * </ol>
     *
